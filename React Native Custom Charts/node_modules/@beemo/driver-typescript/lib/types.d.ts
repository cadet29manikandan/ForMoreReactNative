...
export declare type TargetSetting = 'es3' | 'es5' | 'es6' | 'es2015' | 'es2016' | 'es2017' | 'es2018' | 'es2019' | 'es2020' | 'esnext' | 'json' | 'latest';
export declare type ModuleSetting = 'none' | 'commonjs' | 'amd' | 'umd' | 'system' | 'es2015' | 'esnext';
export declare type ModuleResolutionSetting = 'node' | 'classic';
export declare type LibSetting = 'es5' | 'es6' | 'es7' | 'es2015' | 'es2016' | 'es2017' | 'es2018' | 'es2019' | 'es2020' | 'esnext' | 'dom' | 'dom.iterable' | 'webworker' | 'webworker.importscripts' | 'scripthost' | 'es2015.core' | 'es2015.collection' | 'es2015.generator' | 'es2015.iterable' | 'es2015.promise' | 'es2015.proxy' | 'es2015.reflect' | 'es2015.symbol' | 'es2015.symbol.wellknown' | 'es2016.array.include' | 'es2017.object' | 'es2017.sharedmemory' | 'es2017.string' | 'es2017.intl' | 'es2017.typedarrays' | 'es2018.intl' | 'es2018.promise' | 'es2018.regexp' | 'esnext.array' | 'esnext.symbol' | 'esnext.asynciterable' | 'esnext.intl' | 'esnext.bigint';
export declare type JSXSetting = 'preserve' | 'react-native' | 'react' | 'none';
export declare type NewLineSetting = 'lf' | 'crlf';
