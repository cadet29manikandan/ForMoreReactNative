...
export default class SwipeView extends Component {
  ...
  handlePanResponderMove = (e, gestureState) => {
    ...
    if (absDx > this.props.directionalDistanceChangeThreshold) {
      ...
      if (this.props.disableSwipeToLeft && newDX < 0) {
        newDX = 0;
      }
      if (this.props.disableSwipeToRight && newDX > 0) {
        newDX = 0;
      }
  ...
  renderVisibleContent = () => {
    return this.props.renderVisibleContent();
  };
        ...
        >
          {this.state.swipingLeft
            ? (this.props.renderRightView && this.props.renderRightView()) ||
              null
            : (this.props.renderLeftView && this.props.renderLeftView()) ||
              null}
        </View>
